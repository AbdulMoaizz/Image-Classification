...
eye_cascade = cv2.CascadeClassifier('D:\\Uni\\Image Classification\\opencv\\haarcascades\\haarcascade_eye.xml')
...
file_path = os.path.join(directory, "saved_model.pkl")
joblib.dump(best_clf, file_path)

# Save the dictionary to the specified JSON file
file_path = os.path.join(directory, "class_dictionary.json")
