    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            data = [
                {
                    class: "viral_kohli",
                    class_probability: [1.05,20.20, 12.67, 22.00, 4.5, 91.56],
                    class_dictionary: {
                        babr_azam:0,
                        lionel_messi: 1,
                        maria_sharapova: 2,
                ...
                {
                    class: "roder_federer",
                    class_probability: [7.02,10.10, 23.7, 52.00, 6.1, 1.62],
                    class_dictionary: {
                        babr_azam:0,
                        lionel_messi: 1,
                        maria_sharapova: 2,
            ...
            */
            ...
            let players = ["babar_azam","lionel_messi", "maria_sharapova", "roger_federer", "serena_williams", "virat_kohli"];
